...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://echocarnival.com.hk/services' },
  openGraph: {
    title: 'ECHO HK Carnival | 嘉年華服務香港｜充氣設施・ESG活動・汽球佈置',
    description:
      '9 大嘉年華配套服務：充氣彈床、氣球佈置、小丑魔術、DIY 工作坊、舞台表演及活動牌照申請。適合學校中華文化日、企業 ESG 團建及商場嘉年華，免費諮詢。',
    url: 'https://echocarnival.com.hk/services',
